...
install -m644 "$HERE/share/icons/hicolor/scalable/apps/supvan-e10-label-studio.svg" "$ICONDIR/supvan-e10-label-studio.svg"

if command -v update-desktop-database >/dev/null 2>&1; then
  update-desktop-database "$DESKTOPDIR" >/dev/null 2>&1 || true
fi

echo "SUPVAN E10 Label Studio installed."
